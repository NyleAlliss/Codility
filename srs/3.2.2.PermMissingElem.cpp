...
Task Score:			100%                                        Created:        03/12/2020
...
//Past this function to Codility to test
int solution(std::vector<int>& A) {

	long long int n = (long long)A.size() + 1;					//size of this variable caused problem in previous attempt
